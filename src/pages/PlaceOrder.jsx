...
import CartTotal from '../Compmnents/CartTotal'
 ...
 let {navigate} = useContext(ShopContext);
  ...
  <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t '>
    ...
    <div className='flex gap-3'>
      <input className='border border-gray-300 rounded py-1.5 px-3.5 w-full' placeholder='Frist name' type="text" />
    ...
    <input className='border border-gray-300 rounded py-1.5 px-3.5 w-full' placeholder='Phone' type="tell" />
    </div>
